    ...
    <div className="min-h-screen">
      ...
      <section id="contact" className="section-padding">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-center text-gray-600 dark:text-slate-300 mb-8 text-lg">
            {t.contact.description}
          </p>
          <div className={`bg-white dark:bg-slate-800 rounded-3xl p-6 md:p-8 shadow-xl ${getThemeClasses.cardShadow()} ${getThemeClasses.cardBorder()}`}>
            <div className="text-center">
              <div className="group">
                <div className={`w-12 h-12 ${getThemeClasses.iconGradient()} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform ${getThemeClasses.iconShadow()}`}>
